...
const Portfolio = () => {
    return (
            <div className="py-4 product mt-8" id='project'>
                <h2 className="my-2 text-center text-3xl text-white-500 uppercase font-bold" style={{ textShadow: '1px 1px 2px #000000' }}>Projects</h2>
                <div className='flex justify-center'>
                    <div className='w-24 border-b-4 border-white-900 mb-8'></div>
                </div>

                <div className="px-4 mb-8" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max card">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 card">
                            <div className="m-2 text-justify text-sm">
